...
public class OrderSummaryActivityTest {
    ...
    @Rule
    public IntentsTestRule<OrderSummaryActivity> mOrderSummaryActivityTest =
            new IntentsTestRule<OrderSummaryActivity>(OrderSummaryActivity.class);
    ...
    public void clickSendEmailButton_SendsEmail() {
        ...
        // intented(Matcher<intent>) asserts the given matcher matches one and only one
